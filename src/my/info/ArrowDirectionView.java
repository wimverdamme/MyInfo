...
public class ArrowDirectionView extends TextView {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawLine(width / 2 + x2, height / 2 + y2, width / 2 + x3, height
				/ 2 + y3, mPaint);
		canvas.drawLine(width / 2 + x6, height / 2 + y6, width / 2 + x2, height
				/ 2 + y2, mPaint);
		canvas.drawLine(width / 2 + x7, height / 2 + y7, width / 2 + x2, height
				/ 2 + y2, mPaint);
